    ...
    return (
        <div>
            ...
            <div class="d-flex align-items-start">
                <div class="nav flex-column nav-pills ms-3" id="v-pills-tab" role="tablist">

                    <a class="nav-link active" data-bs-toggle="pill" href="#v-pills-settings" role="tab">Настройки</a>
                    <a class="nav-link" data-bs-toggle="pill" href="#v-pills-templateNC" role="tab">ШаблонНП</a>
                    <a class="nav-link" data-bs-toggle="pill" href="#v-pills-templateEC" role="tab">ШаблонОП</a>
                    <a class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-profile" role="tab">Личные
                данные</a>
                </div>
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-settings" role="tabpanel">Что показывать</div>
                    <div class="tab-pane fade" id="v-pills-templateNC" role="tabpanel">Шаблон для нового поздравляющего</div>
                    <div class="tab-pane fade" id="v-pills-templateEC" role="tabpanel">Шаблон для опытного поздравляющего</div>
